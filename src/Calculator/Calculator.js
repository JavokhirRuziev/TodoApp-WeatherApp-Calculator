  ...
  return (
    <div>
      ...
      <Grid container rowSpacing={1} columnSpacing={1} style={{marginBottom:'10px'}}>
          <Grid item xs={3}><LabelButton onClick={clear} style={{width:'90%'}}><ArrowRightAltIcon/></LabelButton></Grid>
      ...
      <Grid container rowSpacing={1} columnSpacing={1} style={{marginBottom:'10px'}}>
        <Grid item xs={3}><DigitButton onClick={show} style={{width:'90%'}}>1</DigitButton></Grid>
        <Grid item xs={3}><DigitButton onClick={show} style={{width:'90%'}}>2</DigitButton></Grid>
        <Grid item xs={3}><DigitButton onClick={show} style={{width:'90%'}}>3</DigitButton></Grid>
        <Grid item xs={3}><Button ref={ref} onClick={show} style={{width:'90%'}} variant='contained' color='error'>-</Button></Grid>
        <Grid item xs={3}><DigitButton onClick={show} style={{width:'90%'}}>4</DigitButton></Grid>
        <Grid item xs={3}><DigitButton onClick={show} style={{width:'90%'}}>5</DigitButton></Grid>
        <Grid item xs={3}><DigitButton onClick={show} style={{width:'90%'}}>6</DigitButton></Grid>
        <Grid item xs={3}><Button ref={ref} onClick={show} style={{width:'90%'}} variant='contained' color='error'>+</Button></Grid>
        <Grid item xs={3}><DigitButton onClick={show} style={{width:'90%'}}>7</DigitButton></Grid>
        <Grid item xs={3}><DigitButton onClick={show} style={{width:'90%'}}>8</DigitButton></Grid>
        <Grid item xs={3}><DigitButton onClick={show} style={{width:'90%'}}>9</DigitButton></Grid>
        <Grid item xs={3}><Button ref={ref} onClick={show} style={{width:'90%'}} variant='contained' color='error'>/</Button></Grid>
      </Grid>
      <Grid container rowSpacing={1} columnSpacing={1} style={{marginBottom:'10px'}}>
        <Grid item xs={3}><LabelButton onClick={show} style={{width:'90%'}}>.</LabelButton></Grid>
